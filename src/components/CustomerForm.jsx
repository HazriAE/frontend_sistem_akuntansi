...
// Main Form Component
const CustomerForm = ({ mode, formik, createMutation, updateMutation, handleBack }) => {
    ...
    <div className="card bg-base-100 shadow-xl max-w-4xl mx-auto">
      <div className="card-body">
        <h2 className="card-title text-2xl mb-4">
          {mode === 'edit' ? 'Edit Customer' : 'Tambah Customer Baru'}
        </h2>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            >
              {isLoading ? (
                ...
                <>
                  <FiSave size={18} />
                  {mode === 'edit' ? 'Update Customer' : 'Simpan Customer'}
                </>
              )}
            </button>
          </div>
